...
<head>
	...
	<title>K.O. | Edit Data Produk</title>
		...
		<div class="container">
			...
			<div class="box">
				<form action="" method="POST" enctype="multipart/form-data">
					...
					<img src="../produk/<?php echo $p->product_image ?>" width="500px">
					...
					<select class="input-control" name="status">
						...
						<option value="0" <?php echo ($p->product_status == 1)? 'selected':'' ?>>Tidak Aktif</option>
					</select>
